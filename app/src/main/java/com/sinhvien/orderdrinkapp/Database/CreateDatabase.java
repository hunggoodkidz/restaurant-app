...
public class CreateDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String tblLuong = "CREATE TABLE LUONG(MALUONG INTEGER PRIMARY KEY AUTOINCREMENT, LUONGTHUONG INTEGER,LUONGPHAT INTEGER,SOGIO INTEGER,NGAYTHANG TEXT,MANV INTEGER REFERENCES NHANVIEN(MANV))";
