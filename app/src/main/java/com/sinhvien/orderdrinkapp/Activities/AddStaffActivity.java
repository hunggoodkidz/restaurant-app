...
public class AddStaffActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    RadioButton RD_addstaff_Nam,RD_addstaff_Nu,RD_addstaff_Khac,rd_addstaff_QuanLy,rd_addstaff_NhanVien,rd_addstaff_DauBep;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rd_addstaff_DauBep = findViewById(R.id.rd_addstaff_DauBep);
        ...
        if(manv != 0){
            ...
            }else if(nhanVienDTO.getMAQUYEN()==2) {
                rd_addstaff_NhanVien.setChecked(true);
            }else{
                rd_addstaff_DauBep.setChecked(true);
            }
        ...
        switch (id){
            case R.id.btn_addstaff_ThemNV:
                ...
                switch (rg_addstaff_Quyen.getCheckedRadioButtonId()){
                    ...
                    case R.id.rd_addstaff_DauBep: quyen =3;break;
                }
